...
const eventsSeasonRouter = require("./eventsSeason.routes");
const seasonPointsRouter = require("./seasonPoints.routes");
...
routes.use('/eventsSeason', eventsSeasonRouter);
routes.use('/seasonPoints', seasonPointsRouter);
